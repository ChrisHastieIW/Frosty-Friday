...
create or replace schema WEEK_62;
...
PUT 'FILE:///C:/My/Path/To/application_files/manifest.yml' @"CH_FROSTY_FRIDAY"."WEEK_62"."STG_NATIVE_APP_CONTENT" overwrite=true auto_compress=false;
PUT 'FILE:///C:/My/Path/To/application_files/scripts/setup.sql' @"CH_FROSTY_FRIDAY"."WEEK_62"."STG_NATIVE_APP_CONTENT"/scripts overwrite=true auto_compress=false;
PUT 'FILE:///C:/My/Path/To/application_files/streamlit/streamlit_interface.py' @"CH_FROSTY_FRIDAY"."WEEK_62"."STG_NATIVE_APP_CONTENT"/streamlit overwrite=true auto_compress=false;
PUT 'FILE:///C:/My/Path/To/README.md' @"CH_FROSTY_FRIDAY"."WEEK_62"."STG_NATIVE_APP_CONTENT" overwrite=true auto_compress=false;
